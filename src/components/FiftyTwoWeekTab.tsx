...
function SkeletonRow() {
  const pulse: React.CSSProperties = {
    ...
    borderRadius: "4px",
    animation: "w52Pulse 1.4s ease-in-out infinite",
  };
  return (
    <tr>
...
export function FiftyTwoWeekTab() {
  ...
  return (
    <div style={{ backgroundColor: "#0d0d0d", minHeight: "100vh" }}>
      ...
      >
        <div>
          <div style={{ color: "#ccc", fontSize: "13px", fontWeight: "bold" }}>
            🚀 52-Week High Breakout Scanner
          </div>
          <div style={{ color: "#555", fontSize: "11px", marginTop: "2px" }}>
            Stocks within 0.5% of 52W High with 2x+ Volume — Institutional
            Breakouts Only
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <button onClick={doFetch} style={{ ...btnBase, padding: "5px 14px" }}>
            ↻ Refresh
          </button>
        </div>
      </div>
      ...
      >
        ...
        {(["ALL", "ABOVE_HIGH", "AT_HIGH"] as const).map((f) => (
          <button
            key={f}
            style={typeFilter === f ? btnActive : btnBase}
          ...
          >
            ...
            >
              {f === "ALL"
                ? stocks.length
                : stocks.filter((s) => s.breakout_type === f).length}
            </span>
          </button>
        ))}
        ...
        {(["ALL", "STRONG", "MODERATE"] as const).map((f) => (
          <button
            key={f}
            style={strengthFilter === f ? btnActive : btnBase}
          ...
          >
            ...
            >
              {f === "ALL"
                ? stocks.length
                : stocks.filter((s) => s.strength === f).length}
            </span>
          </button>
        ))}
        ...
        {loading ? (
          ...
          >
            ...
            <span style={{ color: "#555", fontSize: "14px" }}>
              No institutional breakouts detected today
            </span>
            <span style={{ color: "#444", fontSize: "12px" }}>
              Requirements: within 0.5% of 52W High, volume ratio ≥ 2x
            </span>
          </div>
        ) : (
          <div
            ...
            >
              ...
              <tbody>
                {filtered.map((row, ri) => {
                  ...
                  const pctColor =
                    row.pct_from_high >= 0 ? "#00C853" : "#FFD600";
                  const volColor =
                    row.volume_ratio >= 3 ? "#00C853" : "#FFD600";
                  return (
                    <tr key={row.symbol}>
                      <td
                        style={{
                      ...
                      >
                        ₹{row.week52_high.toLocaleString("en-IN")}
                      </td>
                      <td
                        style={{
                          ...tdStyle,
